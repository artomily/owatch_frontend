  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <section className="relative z-10 px-4 py-12">
        <div className="max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-purple-300 text-sm font-medium mb-6">
          ...
          <p className="text-slate-300 mb-8 text-lg">
            Get O'Watch.ID on your mobile device and start earning on the go
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-3 bg-black hover:bg-gray-900 text-white px-6 py-3 rounded-xl font-medium transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105"
            >
              <svg
                className="w-8 h-8"
                viewBox="0 0 24 24"
